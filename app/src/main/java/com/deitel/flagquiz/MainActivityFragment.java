...
public class MainActivityFragment extends Fragment {
   ...
   private String correctAnswer; // correct state for the current state
   private int totalGuesses; // number of guesses made
   private int correctAnswers; // number of correct guesses
   private int guessRows; // number of rows displaying guess Buttons
   private SecureRandom random; // used to randomize the quiz
   private Handler handler; // used to delay loading next state
   private Animation shakeAnimation; // animation for incorrect guess

   private LinearLayout quizLinearLayout; // layout that contains the quiz
   private TextView questionNumberTextView; // shows current question #
   private ImageView stateImageView; // displays a state
   ...
   public void resetQuiz() {
      ...
      try {
         ...
         for (String region : regionsSet) {
            // get a list of all state image files in this region
      ...
      // add STATES_IN_QUIZ random file names to the quizCountriesList
      ...
      loadNextState(); // start the quiz by loading the first state
   }

   // after the user guesses a correct state, load the next state
   private void loadNextState() {
      // get file name of the next state and remove it from the list
      ...
      try (InputStream stream =
         ...
         animate(false); // animate the state onto the screen
      }
      catch (IOException exception) {
   ...
   // parses the country state file name and returns the country name
   ...
   private OnClickListener guessButtonListener = new OnClickListener() {
      ...
      public void onClick(View v) {
         ...
         if (guess.equals(answer)) { // if the guess is correct
            ...
            // if the user has correctly identified STATES_IN_QUIZ states
            if (correctAnswers == STATES_IN_QUIZ) {
               ...
               handler.postDelayed(
                  new Runnable() {
                     @Override
                     public void run() {
                        animate(true); // animate the state off the screen
                     }
